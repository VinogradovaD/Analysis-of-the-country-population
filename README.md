...
Первое, что видит наш пользователь при открытии программы – это окно авторизации. Нажав на кнопку регистрации, пользователь может внести свои данные в базу данных.
